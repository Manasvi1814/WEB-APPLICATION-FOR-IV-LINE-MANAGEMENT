...
import { Users, Plus, Edit3, Trash2, Building, Shield } from "lucide-react";

const ADMIN_PIN = "1234"; // TODO: move to env / secure storage

const AdminPanel: React.FC = () => {
  const { user } = useAuth(); // not used for blocking, but keep if needed later
  ...
  const handleUnlock = () => {
    if (pinInput === ADMIN_PIN) {
      ...
      setLockError("Incorrect admin PIN.");
    }
  };
  ...
  return (
    <div className="space-y-6">
      {/* PIN lock like Reports */}
      {isLocked && (
        <div className="max-w-md mx-auto mt-4 space-y-3 rounded-lg border border-red-200 bg-red-50 p-4">
          <p className="text-sm font-semibold text-red-800">
            Admin access required
          </p>
          <p className="text-xs text-red-700">
            Only staff with the admin PIN can manage staff and departments.
          </p>
      ...
      {/* Main Admin Panel only after PIN */}
      {!isLocked && (
        <>
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
              <div className="flex items-center">
                ...
                <div>
                  <p className="text-2xl font-bold text-gray-900">
                    {
                      staff.filter((s: any) => s.status === "active")
                        .length
                    }
                  </p>
                  ...
                  >
                    ...
                    <div className="flex justify-between items-center mt-4">
                      <span className="text-sm text-gray-500">
                        {
                          staff.filter(
                            (s: any) => s.department_id === department.id
                          ).length
                        }{" "}
                        staff members
                      </span>
